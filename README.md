...
This document explains how **Object-Oriented Programming (OOP)** principles were applied in designing the Roulette Betting System. The goal was to create a modular, scalable, and maintainable architecture using fundamental OOP concepts.

### 6.1 Encapsulation

Encapsulation ensures that data is hidden and only accessible through controlled interfaces.
...
The system leverages inheritance to create a common structure for different bet types.
...
Polymorphism enables different bet types to be processed through a common interface.
...
Abstraction simplifies complex logic by exposing only the necessary details.
